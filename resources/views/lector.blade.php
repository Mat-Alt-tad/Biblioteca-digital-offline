    ...
    <div class="relative bg-white">
        ...
        <div class="w-full h-20 bg-green-700 flex items-center justify-between px-4 rounded-t-lg">
            <div class="flex items-center">
                ...
                <p class="text-white text-lg font-bold">PDF Viewer</p>
            </div>
        ...
        <div class="flex justify-center gap-6 mt-8">
            <button class="w-64 h-16 bg-green-700 text-white text-lg font-bold rounded-full shadow-md">
                Descargar PDF
            </button>
            <button class="w-64 h-16 bg-green-700 text-white text-lg font-bold rounded-full shadow-md">
                Mostrar PDF
       ...
       <!-- Contenedor del PDF -->
        <div class="w-full max-w-6xl mx-auto mt-8 bg-gray-200 rounded-lg p-4">
            <div class="relative w-full h-[1000px] bg-gray-300 rounded-lg overflow-hidden">
                <!-- Visualizador de PDF -->
                <iframe 
                    src="{{ asset('pdf/arbol de saberes.pdf') }}" 
